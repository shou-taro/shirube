...
- ✏️ **Draw your own relationships** — when the database declares no foreign key, shirube
  can't see that two tables are related; draw the missing link yourself, column to column,
  as a dotted edge, saved per connection and never touching your database.
