...
import { fetchHealth, type Profile } from '@/lib/api'
 ...
 * navigator (right) — beneath a top bar. A placeholder skeleton for now: the panes are
 * filled in by later feature work (schema introspection, table detail, the AI).
 */
