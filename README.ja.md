...
- 🧭 **2 つのテーブルを結ぶ経路をたどる** — 行き先を選ぶと、今いるテーブルからそこまでの最短経路を小さな図で示します。経路上のテーブルを箱で並べ、隣り合う箱は「どの列でつながるか」で結ぶので、順番だけでなくつながり方まで見えます。箱をクリックすると地図がそのテーブルへ移動し、経路を 1 テーブルずつ辿れます。
